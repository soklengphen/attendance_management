...
-- Users table (with password for auth)
CREATE TABLE users (
    user_id INT PRIMARY KEY AUTO_INCREMENT,
    full_name VARCHAR(100) NOT NULL,
    email VARCHAR(100) UNIQUE NOT NULL,
    password VARCHAR(255) NOT NULL,          -- new column for hashed password
...
-- Use PHP's password_hash() to generate the hash
INSERT INTO users (full_name, email, password, department, role) VALUES
('John Doe', 'john.doe@company.com', '$2y$10$examplehashedpassword1', 'Engineering', 'employee'),
('Jane Smith', 'jane.smith@company.com', '$2y$10$examplehashedpassword2', 'HR', 'employee'),
('Mike Johnson', 'mike.johnson@company.com', '$2y$10$examplehashedpassword3', 'Marketing', 'employee'),
('Sarah Wilson', 'sarah.wilson@company.com', '$2y$10$examplehashedpassword4', 'Engineering', 'teacher'),
('Admin User', 'admin@company.com', '$2y$10$examplehashedpassword5', 'Administration', 'admin');
